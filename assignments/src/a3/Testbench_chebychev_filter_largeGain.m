...
% Linearly spaced frequency points between 1Hz and 20000 Hz
...
load Chebychev_reference_solution_largeGain;
...
title('Active Chebychev Filter - High Gain OpAmps')
...
% save Chebychev_reference_solution_largeGain reference_gain reference_angle
% save Chebychev_noise_largeGain random_noise
